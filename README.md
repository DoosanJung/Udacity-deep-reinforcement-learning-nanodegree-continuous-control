...
1. `model.py` implements the Deep Deterministic Polich Gradient (DDPG). This currently contains fully-connected neural network with ReLU activation. You can change the structure of the neural network and play with it.
